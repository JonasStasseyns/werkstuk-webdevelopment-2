    ...
    <div class="nav-wrapper"
        ...
        <div class="links auth-links"
            ...
            <div class="link-container"
                 style="margin: 0;padding: 0.5vw 0.5vw 0.2vw 0.5vw;font-family: &quot;Roboto&quot;, sans-serif;line-height: 150%;display: flex;align-items: center;margin-right: 1vw;">
                <a href="" class="link"
                   style="margin: 0;padding: 0;font-family: &quot;Roboto&quot;, sans-serif;line-height: 150%;text-decoration: none;color: #212121;font-variant: all-small-caps;"></a>
            </div>
            <div class="link-container"
                 style="margin: 0;padding: 0.5vw 0.5vw 0.2vw 0.5vw;font-family: &quot;Roboto&quot;, sans-serif;line-height: 150%;display: flex;align-items: center;margin-right: 1vw;">
...
<div class="wrapper"
    ...
    <div class="blog-index-container"
        ...
        <div class="post-detail-container"
            ...
            <p style="margin: 0;padding: 0;font-family: &quot;Roboto&quot;, sans-serif;line-height: 150%;">{{$message_text}}</p>
        </div>
    </div>
</div>
<div class="footer"
